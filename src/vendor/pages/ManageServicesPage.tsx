      ...
      <div className="p-6 md:p-10 lg:px-12 animate-fade-in">
        <div className="max-w-7xl mx-auto">
          <header className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Manage Services</h1>
              <p className="text-slate-500 mt-1 text-base">Add, edit or remove the services you offer to customers.</p>
            </div>
            <button
              onClick={openAddForm}
              className="bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg font-semibold shadow-sm active:scale-95 transition-all"
            >
